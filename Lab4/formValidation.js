...
function validateLogin(){
    ...
    if(user_account_validation()){
        document.getElementById("user_account").focus();
        return false;
    }else if(user_password_validation()){
...
function user_account_validation(){
    var admin_account = document.getElementById("user_account").value;
    
    if(admin_account == ""){
        alert("Please provide your account!");
        alertForEmptyInput("user_account_alert_string", "User account");
        return true;
    }else if(admin_account.trim() == ""){
        alertForCertainInputError("user_account_alert_string", "empty space");
...
function user_password_validation(){
    var user_password = document.getElementById("user_password").value;
    if(user_password == ""){
        alert("Please provide your account!");
        alertForEmptyInput("user_password_alert_string", "User password");
        return true;
    }else if(user_password.trim() == ""){
        alertForCertainInputError("user_password_alert_string", "empty space");
        alert("Your input cannot only contain space character !");
        return true;
    }
    return false;
